...
export const PRICING_CONFIG = {
  ...
  marketplace: {
    buyerServiceFeeRate: 0.03, // 3.0% payé par l'acheteur pour la sécurisation Escrow
  ...
  // Feature Flags de Phase 0 (Mode Gratuit / Rétention)
  phase0: {
...
export function calculateOrderBreakdown(params: {
  ...
  // En Phase 0, si les frais sont désactivés pour les vendeurs :
  const sellerCommission = PRICING_CONFIG.phase0.isFreeModeActive
    ? 0
